      ...
      <div className="datatable-crud-demo">
        ...
        <div className="card">
          ...
          <DataTable ref={(el) => this.dt = el} value={this.state.products} selection={this.state.selectedProducts} onSelectionChange={(e) => this.setState({ selectedProducts: e.value })}
            ...
            <Column field="name" header="Tên Khu Trọ" ></Column>
            <Column field="address" header="Địa chỉ" ></Column>
            <Column field="inventoryStatus" header="Tình trạng" body={this.statusBodyTemplate} ></Column>
            ...
            <div className="p-formgrid p-grid">
              <div className="p-field-radiobutton p-col-6">
                <RadioButton
                  ...
                  checked={this.state.product.inventoryStatus === "Còn Phòng"}
                />
              ...
              <div className="p-field-radiobutton p-col-6">
                <RadioButton
                  ...
                  value="Hết Phòng"
                  onChange={this.onStatusChange}
                  checked={this.state.product.inventoryStatus === "Hết Phòng"}
                />
              ...
              <div className="p-field-radiobutton p-col-6">
                <RadioButton
                  ...
                  value="Đang sửa chữa"
                  onChange={this.onStatusChange}
                  checked={this.state.product.inventoryStatus === "Đang sửa chữa"}
                />
                <label htmlFor="inventoryStatus3">Đang sửa chữa</label>
              </div>
            </div>
          </div>
        </Dialog>
